...
from computable_flows_shim.logging import (
    SDKLogger, get_logger, log_performance, configure_logging,
    JSONFormatter, _configure_from_env
)
...
class TestConfigureLogging:
    ...
    def test_configure_logging_calls_sdk_logger(self):
        ...
        with patch('computable_flows_shim.logging.SDKLogger.configure') as mock_configure:
