...
class CheckpointManager:
    ...
    def create_checkpoint(
        ...
        checkpoint_data = {
            ...
            "telemetry_summary": self._summarize_telemetry(telemetry_history) if telemetry_history else {}
        }
    ...
    def rollback_to_checkpoint(self, checkpoint_id: str, target_run_id: str) -> Dict[str, Any]:
        """
    ...
    def _summarize_telemetry(self, telemetry_history: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
